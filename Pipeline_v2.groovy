...
//add                   
                        ...
                        if("${env.RELEASE_SCOPE}"=="tst")
                          {
                          if(mgr.setBuildNumber(Integer.valueOf(BUILD_NUM))) {
                           mgr.addBadge('/static/13bdf8d5/plugin/promoted-builds/icons/16x16/star-orange.png', 'deployed on TST',"${env.BUILD_URL}")
                           }
                          }
                         ...
                         if("${env.RELEASE_SCOPE}"=="dev")
                            {
                            if(mgr.setBuildNumber(Integer.valueOf(BUILD_NUM))) {
                             mgr.addBadge('/static/13bdf8d5/plugin/promoted-builds/icons/16x16/star-purple.png', 'deployed on DEV',"${env.BUILD_URL}")
                             }
                           }
                        ...
                        if("${env.RELEASE_SCOPE}"=="pte")
                          {
                            if(mgr.setBuildNumber(Integer.valueOf(BUILD_NUM))) {
                             mgr.addBadge('/static/13bdf8d5/plugin/promoted-builds/icons/16x16/star-red.png', 'deployed on PTE',"${env.BUILD_URL}")
                            }
                          }
